...
<label style="padding-right: 20px;"><h3>School Building</h3></label>
		...
		<div class="col col-md-4 schoolBldTabsDiv">
			<ul class="nav nav-tabs nav-stacked text-center" role="tablist">
				...
				<li role="presentation"><a href="#Toilets"
					...
					onclick="getToiletDetails()"><b>Toilets</b></a></li>
				<li role="presentation"><a href="#Classrooms"
					aria-controls="profile" role="tab" data-toggle="tab"
					onclick="getClassRoomDetails()"><b>Classrooms</b></a></li>
				<li role="presentation"><a href="#CommonArea"
					aria-controls="profile" role="tab" data-toggle="tab"
					onclick="getSchCommonAreaDetails()"><b>Common Area</b></a></li>
			</ul>
		</div>
													...
													<table class="table">
														...
														<tr>
															<td><a href="#">Tube Lights</a> <input
																...
																<input type="text" name="BL_TubeLights_Count"
														...
														<tr>
															<td><a href="#">Reading Tables</a> <input
																...
																name="BL_ReadingTables_Count"
																id="BL_ReadingTables_Count" /></td>
															<td><a href="#">Locker Units</a> <input
														...
														<tr>
															...
															<td><a href="#">Glass Door Almira</a> <input
																...
																id="BL_Glass-Door-Almira" /><br> <input
																type="text" name="BL_Glass-Door-Almira_Count"
														...
														<tr>
															<td><a href="#">S Type Chairs</a> <input
																...
																id="BL_S_Type_Chairs"><br> <input
																type="text" name="BL_S_Type_Chairs_Count"
																id="BL_S_Type_Chairs_Count" /></td>
															<td><a href="#">Store well Almira</a> <input
														...
														<tr>
															<td><a href="#">Green Boards</a> <input
																type="checkbox" name="BL_Green_Board"
																id="BL_Green_Board"><br> <input type="text"
															...
															<td><a href="#">Table Fans</a> <input
																...
																<input type="text" name="BL_Table_Fans_Count"
													...
													<table class="table">
														...
														<tr>
															<td><a href="#">Tube Lights</a> <input
																...
																<input type="text" name="PL_TubeLights_Count"
														...
														<tr>
															<td><a href="#">Reading Tables</a> <input
																...
																name="PL_ReadingTables_Count"
																id="PL_ReadingTables_Count" /></td>
															<td><a href="#">Locker Units</a> <input
														...
														<tr>
															...
															<td><a href="#">Glass Door Almira</a> <input
																...
																id="PL_Glass-Door-Almira" /><br> <input
																type="text" name="PL_Glass-Door-Almira_Count"
														...
														<tr>
															<td><a href="#">S Type Chairs</a> <input
																...
																id="PL_S_Type_Chairs"><br> <input
																type="text" name="PL_S_Type_Chairs_Count"
																id="PL_S_Type_Chairs_Count" /></td>
															<td><a href="#">Store well Almira</a> <input
														...
														<tr>
															<td><a href="#">Green Boards</a> <input
																type="checkbox" name="PL_Green_Board"
																id="PL_Green_Board"><br> <input type="text"
																name="PL_Green_Board_Count" id="PL_Green_Board_Count" /></td>
															<td><a href="#">Table Fans</a> <input
																type="checkbox" name="PL_Table_Fans" id="PL_Table_Fans" /><br>
																<input type="text" name="PL_Table_Fans_Count"
													...
													<table class="table">
														...
														<tr>
															<td><a href="#">Tube Lights</a> <input
																...
																<input type="text" name="CL_TubeLights_Count"
														...
														<tr>
															<td><a href="#">Reading Tables</a> <input
																...
																name="CL_ReadingTables_Count"
																id="CL_ReadingTables_Count" /></td>
															<td><a href="#">Locker Units</a> <input
														...
														<tr>
															...
															<td><a href="#">Glass Door Almira</a> <input
																...
																id="CL_Glass-Door-Almira" /><br> <input
																type="text" name="CL_Glass-Door-Almira_Count"
														...
														<tr>
															<td><a href="#">S Type Chairs</a> <input
																...
																id="CL_S_Type_Chairs"><br> <input
																type="text" name="CL_S_Type_Chairs_Count"
																id="CL_S_Type_Chairs_Count" /></td>
															<td><a href="#">Store well Almira</a> <input
														...
														<tr>
															<td><a href="#">Green Boards</a> <input
																type="checkbox" name="CL_Green_Board"
																id="CL_Green_Board"><br> <input type="text"
																name="CL_Green_Board_Count" id="CL_Green_Board_Count" /></td>
															<td><a href="#">Table Fans</a> <input
																type="checkbox" name="CL_Table_Fans" id="CL_Table_Fans" /><br>
																<input type="text" name="CL_Table_Fans_Count"
													...
													<table class="table">
														...
														<tr>
															<td><a href="#">Tube Lights</a> <input
																...
																<input type="text" name="ZL_TubeLights_Count"
														...
														<tr>
															<td><a href="#">Reading Tables</a> <input
																...
																name="ZL_ReadingTables_Count"
																id="ZL_ReadingTables_Count" /></td>
															<td><a href="#">Locker Units</a> <input
														...
														<tr>
															...
															<td><a href="#">Glass Door Almira</a> <input
																...
																id="ZL_Glass-Door-Almira" /><br> <input
																type="text" name="ZL_Glass-Door-Almira_Count"
														...
														<tr>
															<td><a href="#">S Type Chairs</a> <input
																...
																id="ZL_S_Type_Chairs"><br> <input
																type="text" name="ZL_S_Type_Chairs_Count"
																id="ZL_S_Type_Chairs_Count" /></td>
															<td><a href="#">Store well Almira</a> <input
														...
														<tr>
															<td><a href="#">Green Boards</a> <input
																type="checkbox" name="ZL_Green_Board"
																id="ZL_Green_Board"><br> <input type="text"
																name="ZL_Green_Board_Count" id="ZL_Green_Board_Count" /></td>
															<td><a href="#">Table Fans</a> <input
																type="checkbox" name="ZL_Table_Fans" id="ZL_Table_Fans" /><br>
																<input type="text" name="ZL_Table_Fans_Count"
													...
													<table class="table">
														...
														<tr>
															<td><a href="#">Tube Lights</a> <input
																...
																<input type="text" name="CO_TubeLights_Count"
														...
														<tr>
															<td><a href="#">Reading Tables</a> <input
																...
																name="CO_ReadingTables_Count"
																id="CO_ReadingTables_Count" /></td>
															<td><a href="#">Locker Units</a> <input
														...
														<tr>
															...
															<td><a href="#">Glass Door Almira</a> <input
																...
																id="CO_Glass-Door-Almira" /><br> <input
																type="text" name="CO_Glass-Door-Almira_Count"
														...
														<tr>
															<td><a href="#">S Type Chairs</a> <input
																...
																id="CO_S_Type_Chairs"><br> <input
																type="text" name="CO_S_Type_Chairs_Count"
																id="CO_S_Type_Chairs_Count" /></td>
															<td><a href="#">Store well Almira</a> <input
														...
														<tr>
															<td><a href="#">Green Boards</a> <input
																type="checkbox" name="CO_Green_Board"
																id="CO_Green_Board"><br> <input type="text"
																name="CO_Green_Board_Count" id="CO_Green_Board_Count" /></td>
															<td><a href="#">Table Fans</a> <input
																type="checkbox" name="CO_Table_Fans" id="CO_Table_Fans" /><br>
																<input type="text" name="CO_Table_Fans_Count"
					...
					<div id="divMenu-ul">
						<ul id="class-ul">
							...
							<li style="margin-bottom: 20px;"><a href="#"><b
								...
								type="text" name="S_entancelobby" id="S_entancelobby" /></li>
